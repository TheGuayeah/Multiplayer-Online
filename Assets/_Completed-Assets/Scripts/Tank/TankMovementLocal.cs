...
namespace Complete
{
    public class TankMovementLocal : MonoBehaviour
    {
        ...
        public void setMoveInputVal(InputAction.CallbackContext context)
        {
            var val = context.ReadValue<float>();
            m_MovementInputValue = val;
        }

        public void setRotationInputVal(InputAction.CallbackContext context)
        {
            var val = context.ReadValue<float>();
            m_TurnInputValue = val;
        }
